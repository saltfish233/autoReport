...
currentLocation = id("eao").findOne(); //className("android.widget.ImageView").clickable(true).id("eao").findOnce();
if(currentLocation){
    currentLocation.click();
    sleep(2000);
    }
...
currentLocation = className("android.widget.TextView").clickable(true).id("iss").findOne(0); //className("android.widget.TextView").clickable(true).id("ist").findOnce();
if(currentLocation){
    currentLocation.click();
    sleep(2000);
}
